 ...
 *
 * 判定口径（2026-09-24 更新，用户驱动）：
 * 红线只留「课程不教的分析用语」。以下标准术语**已从表内移除**，因为课程正文
 * 已正式改用它们（自造词→标准术语）：原形、复数、单数、疑问句、否定句、
 * 形容词（-ed / -ing 形容词）、第三人称（单数）、一般现在时。
 * 理由：用户走查反馈「在中国的说法不用什么昨天版，用的说法叫过去式」——
 * 中国学习者从小学起就学的标准词，比自造说法更好懂、也更可检索。
